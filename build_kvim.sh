...
UBOOT_BL2="${SCRIPT_DIR}/uboot-bins/u-boot.bin.usb.bl2"
UBOOT_TPL="${SCRIPT_DIR}/uboot-bins/u-boot.bin.usb.tpl"
...
[[ -d "${VENDOR_PATH}" ]] && cp "$UBOOT_BL2" "${VENDOR_PATH}/radio/bootloader-bl2.img"
[[ -d "${VENDOR_PATH}" ]] && cp "$UBOOT_TPL" "${VENDOR_PATH}/radio/bootloader-tpl.img"
