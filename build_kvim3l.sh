...
DEVICE_PATH="${LINEAGE_ROOT}/device/khadas/kvim3l"
VENDOR_PATH="${LINEAGE_ROOT}/vendor/khadas/kvim3l"
...
if [[ -d "${VENDOR_PATH}" ]]; then
    cd "$VENDOR_PATH" && git add -A && git commit -m "kvim3l: Update bootloader image prebuilt"
fi
